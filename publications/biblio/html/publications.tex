...
{\catcode`\~=12\catcode`\:=12\catcode`\_=12\catcode`\&=12
  \gdef\RacineHTML{http://enstb.org/~keryell}%
}
\makeatletter
...
\section{Compilation \& Parallelization for HPC and Embedded Systems ---
  \emph{Compilation \& parallélisation}}
...
\section{Hardware Secure Architectures for Distributed Computing ---
  \emph{Sécurité matérielle pour le calcul distribué}}
...
\section{Multimedia, Networking \& P2P --- \emph{Multimédia, réseaux \&
    PàP}}
...
\section{Low Performance Computing \smiley: Domotics ---
  \emph{Informatique à Faible Performance \smiley : domotique}}
\label{sec:inform-faible-perf}

Un clin d'\oe{}il à \textsc{lpf} (\emph{Low Performance Fortran}) \smiley.
...
\section{Operating systems --- \emph{Systèmes d'exploitation}}
...
\section{Presentations --- \emph{Présentations}}
\label{sec:pres-pres}
...
\begin{itemize}
\item Des rapports d'étudiants -- \emph{Some student reports} :
  \LienPDF{\RacineHTML/eleves} ;
\item Au \href{http://departements.telecom-bretagne.eu/info}{Laboratoire d'Informatique} à
  l'\href{http://www.telecom-bretagne.eu}{TÉLÉCOM Bretagne} -- \emph{At the
    \href{http://departements.telecom-bretagne.eu/info}{Computer Science
      Laboratory} of
    \href{http://www.telecom-bretagne.eu}{TÉLÉCOM Bretagne}} :
...
\item Au \href{http://www.di.ens.fr}{Laboratoire d'Informatique} (LIENS)
  de l'\href{http://www.ens.fr}{École Normale Supérieure} (ENS) --
  \emph{At the \href{http://www.di.ens.fr}{Computer Science Department}
    (LIENS) of the \href{http://www.ens.fr}{École normale supérieure}
    (ENS)} : mais où est-ce bien passé ???
\end{itemize}
